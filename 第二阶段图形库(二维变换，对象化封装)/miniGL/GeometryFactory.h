...
public :
	...
	static Geometry2D* createPolylineGeometry( PixelPoint* pts, int size);
	static Geometry2D* createPolylineGeometry(Point2D* pts, int size);
	static Geometry2D* createPolylineGeometry(PixelPoint& pt1, PixelPoint& pt2);
	static Geometry2D* createPolygonGeometry( PixelPoint* pts, int size);
	static Geometry2D* createPolygonOutlineGeometry(PixelPoint* pts, int size);
